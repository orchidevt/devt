...
function contentWarning() {
   const cwar = document.getElementsByClassName("alert-danger")[0];
...
function motesmodals() {
   ...
   for (let i=0; i < motes.length; i++) {
      ...
      motes[i].innerHTML = '<p><i class="fa fa-bookmark-o"></i>' + motes[i].innerHTML + '</p>';
...
function spoilerWarning() {
   const spar = document.getElementsByClassName("alert-warning")[0];
